...
$output_dir = "upload/";/* Path for file upload */
	...
	move_uploaded_file($_FILES["image"]["tmp_name"][0],$output_dir."/".$NewImageName );
		...
		if (mysqli_query($cn, $sql)) {
			...
			echo"<h1 style='text-align: center;background-color:rgb(180, 178, 178) ;font-size: 40px;font-style: italic; opacity: 1.0;margin-top:300px;'>". "You are successfully registered! "."</h1>";
