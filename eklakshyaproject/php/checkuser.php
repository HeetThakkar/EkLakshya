...
if ($pwd == $row['Password']) 
		...
		if ($row['verification']=='verified') 
	{
		...
		{
			echo '<script>alert("You have already voted once! you are not allowed to vote again ");  window.location.href = "../index.html";</script>'; 
		...
		echo '<script>alert("You are not a verified user! ");  window.location.href = "../index.html";</script>'; 
